  ...
  return (
    <div className="absolute inset-0 bg-zinc-900 flex flex-col justify-center items-center space-y-8">
      ...
      <div className="flex flex-row space-x-4">
        <Link href="/qna-rag" className="btn bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
          Q&A RAG
        </Link>
        <Link href="/web-rag" className="btn bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
          Web RAG
        </Link>
        <Link href="/hyde-rag" className="btn bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
          HyDE RAG
        </Link>
        </div>
    </div>
