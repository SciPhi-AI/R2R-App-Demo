    ...
    <div className="absolute inset-0 bg-zinc-900">
          ...
          <div className="flex-grow ml-4">
            <label htmlFor="userId" className="block text-sm font-medium text-zinc-300">
              ...
              >
                ...
                {userTooltipVisible && (
                  <div style={{ width: '250px' }} className="absolute left-6 -top-2 bg-zinc-800 text-zinc-200 px-2 py-1 rounded text-xs z-10 pb-2 pt-2">
                    Each user interacts with the deployed pipeline through an allocated User ID.
                  </div>
                )}
              </span>
            </label>
      ...
      <div className="mx-auto max-w-6xl absolute inset-4 md:inset-8 flex mt-20">
        <div className="w-64 bg-zinc-800 p-3 rounded-l-2xl border-2 border-zinc-600 mt-4">
          <Sidebar apiUrl={apiUrl} userId={userId} uploadedDocuments={uploadedDocuments} setUploadedDocuments={setUploadedDocuments} setLogFetchID={setLogFetchID} />
        </div>
